...
INSERT INTO `staff` VALUES ('Accountant','jPasswordField1','Clark','Kent','Technician',1,0),('Clerk','Paperwork','Julie','Abbot','Shift Manager',0,0),('Copy','Too_dark','John','Hash','Technician -Copy',0,0),('dannyboy123','password','Dan','Peters','Receptionist',1,0),('DavidB','jPasswordField1','David','Beckman','Shift Manager',2,0),('Development','Lot_smell','Lee','Hong','Technician -Development',0,0),('Finish','Fine_touch','Bruce','Wayne','Technician -Finish',0,0),('Hello','Hello_there','Tony','Stank','Receptionist',0,0),('juan22','password','juan','juan','Technician - Packing',1,0),('Manager','Get_it_done','Stewart','Pask','Office Manager',0,0),('Packer','Pack_it','Marina','Scott','Technician -Packing',0,0),('smbagwu','password','Sylvie','Mbagwu','Office Manager',41,1);
...
-- Dump completed on 2018-04-17 18:45:33
