...
--
-- Table structure for table `job_task-bridge`
--

DROP TABLE IF EXISTS `job_task-bridge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `job_task-bridge` (
  ...
  KEY `cdx_idx` (`code`),
  CONSTRAINT `cdx` FOREIGN KEY (`code`) REFERENCES `job` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `taskidx` FOREIGN KEY (`taskID`) REFERENCES `task` (`taskID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `job_task-bridge`
--

LOCK TABLES `job_task-bridge` WRITE;
/*!40000 ALTER TABLE `job_task-bridge` DISABLE KEYS */;
INSERT INTO `job_task-bridge` VALUES (1,'ABN54',1,0),(2,'ABN54',2,0),(3,'ABN54',3,0),(4,'ACN54',1,0),(5,'ACN54',4,0),(6,'ACN54',3,0),(7,'ACT108',1,0),(8,'ACT108',5,0),(9,'ACT108',3,0),(10,'ACT35',6,0),(11,'ACT35',5,0),(12,'ACT35',7,0),(13,'B108',2,0),(14,'B108',3,0),(15,'C108',4,0),(16,'C108',3,0);
/*!40000 ALTER TABLE `job_task-bridge` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-04-17  1:46:30
