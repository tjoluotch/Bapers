...
public class SearchCustomerTableModel extends AbstractTableModel {
 ...
 @Override
    ...
    private String[] columnNames = {"Acc. No", "Forename", "Surname", "Acc. Holder Name", "Address 1", "Address 2", "City", "Postcode", "Phone", "Email"};

    public SearchCustomerTableModel(List<Customer> li) {
        this.li = li;
    }
